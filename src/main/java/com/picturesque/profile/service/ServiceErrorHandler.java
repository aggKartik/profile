...
public class ServiceErrorHandler {
    ...
    public ResponseEntity<Response<PersonAddResponse>> handlePersonIllegalArgument(PersonIllegalArgument e) {
    ...
    public ResponseEntity<Response<FollowAddResponse>> handleFollowIllegalArgument(FollowIllegalArgument e) {
        Response<FollowAddResponse> resp = new Response<FollowAddResponse>(new FollowAddResponse(e.getMessage()),
                HttpStatus.BAD_REQUEST);
