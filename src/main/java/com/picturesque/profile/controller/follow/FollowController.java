...
public class FollowController {
  ...
  public ResponseEntity<Response<PaginatedResponse>> getFollowing(
      @Valid FollowingFollowerRequest req) {
    Response<PaginatedResponse> resp = followService.getFollowerFollowing(req, false);
    return new ResponseEntity<>(resp, resp.getStatusCode());
  }

  @GetMapping(path = "/followers")
  public ResponseEntity<Response<PaginatedResponse>> getFollowers(
      @Valid FollowingFollowerRequest req) {
