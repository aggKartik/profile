...
public class GroupServiceTests {
  ...
  void addGroupTest() {
    ...
    Person person = new Person("John", "JohnDoe", new UserID("-2019924783"),
    ...
    assertThat(resp.getResponse().getMessage(),
            equalTo("Group Test Group added successfully!"));
  ...
  void addPersonNotExistGroup() {
    ...
    assertThrows(GroupIllegalArgument.class, () -> groupService.addGroup(req),
  ...
  void changePersonTest() {
    ...
    GroupPutRequest putRequest = new GroupPutRequest(new GroupID("1234"), "Life's Good",
            "This is a bio.", "xyz.jpg");
    List<UserID> members = new ArrayList<>();
    members.add(new UserID("-2019924783"));
    ...
    assertThat(resp.getStatusCode(), equalTo(HttpStatus.OK));
    assertThat(resp.getResponse().getMessage(),
            equalTo("[Group name modified successfully, " +
  ...
  void changeJustBioTest() {
    ...
    GroupPutRequest putRequest = new GroupPutRequest(new GroupID("1234"), null,
            "This is a bio.", null);
    List<UserID> members = new ArrayList<>();
    members.add(new UserID("-2019924783"));
    Group group = new Group(new GroupID("123"), putRequest.getGroupName(), members, "");
  ...
  void changeJustPictureTest() {
    ...
    assertThat(resp.getStatusCode(), equalTo(HttpStatus.OK));
    assertThat(resp.getResponse().getMessage(),
            equalTo("[Picture added successfully!]"));
  ...
  void changeJustNameTest() {
    ...
    GroupPutRequest putRequest = new GroupPutRequest(new GroupID("1234"), "Test Group 2",
            null, null);
    List<UserID> members = new ArrayList<>();
    members.add(new UserID("-2019924783"));
    Group group = new Group(new GroupID("123"), putRequest.getGroupName(), members, "");
  ...
  void groupNotInDBTest() {
    ...
    assertThrows(GroupIllegalArgument.class,
